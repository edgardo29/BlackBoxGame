# Author: Edgardo Infante
# Date: 08/13/2020
# Description: This program  will show an abstract board game called Black Box.
# It will It takes place on a 10x10 grid. Rows 0 and 9, and columns 0 and 9 (border squares),
